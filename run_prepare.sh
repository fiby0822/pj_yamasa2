...
echo ""
echo "出力ファイル:"
echo "  - s3://fiby-yamasa-prediction-2/output/df_confirmed_order_input_yamasa.parquet"
echo "  - s3://fiby-yamasa-prediction-2/output/df_confirmed_order_input_yamasa_fill_zero.parquet"
echo ""